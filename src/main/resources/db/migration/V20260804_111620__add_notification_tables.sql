...
CREATE TABLE `notifications` (
    ...
    `delivery_scope`    VARCHAR(30) NOT NULL DEFAULT 'WEB_ONLY' COMMENT '발송 범위 (WEB_ONLY, WEB_AND_KAKAO)',
    ...
    -- 프로젝트에 생성되어 있는 부모 테이블(members, orders) FK 연결
    ...
    -- 참고: 아직 미구현된 2차 도메인 테이블(chat_rooms, posts, reviews 등)은
    -- ID 컬럼만 BIGINT NULL로 우선 생성해 두고, 추후 팀원 구현 완료 시 FK를 추가 연결합니다.
...
-- =========================================================
-- 2. notification_deliveries (카카오 알림톡 발송 이력 테이블)
-- =========================================================
CREATE TABLE `notification_deliveries` (
    ...
    `template_code`       VARCHAR(50) NOT NULL COMMENT '카카오 알림톡 템플릿 코드',
