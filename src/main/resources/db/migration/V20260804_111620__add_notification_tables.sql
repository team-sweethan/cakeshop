...
-- 1. notifications 테이블: 질문자님의 MariaDB 원본 스키마와 100% 동일하게 정합성 맞춤
ALTER TABLE `notifications`
    ...
    ADD COLUMN `event_key`         VARCHAR(100) NOT NULL DEFAULT '' COMMENT '동일 이벤트 중복 알림 방지 키' AFTER `read_at`,
...
-- 2. notification_deliveries 테이블: 질문자님의 MariaDB 원본 스키마와 100% 동일하게 정합성 맞춤
...
-- notification_deliveries 인덱스 생성
