...
class CustomerPageControllerTests {
    ...
    void setUp() {
        ...
        // /reviews/new 는 목업이 아니게 되어 뺐다(조각 1). orderItemId 로 주문 상품을 찾아
        // 자격을 검증한 뒤에야 그려지므로, 목업 렌더링 목록에 두면 빈 모델로 실패한다.
        // 이 화면의 렌더링은 ReviewScreenRenderingTests 가 실제 데이터로 확인한다.
