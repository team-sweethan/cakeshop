...
class NotificationCouponSyncTest {
    ...
    void syncCouponExpiringNotifications_expiringCoupon_sendsNotification() {
        ...
        given(couponNotificationQueryService.findExpiringMemberCouponsWithinDays(anyInt(), anyInt()))
                .willReturn(List.of(coupon));
        given(memberNotificationQueryService.isMemberActive(2L)).willReturn(true);
        given(notificationCouponQueryService.isCouponExpiringNotificationSentOrInactive(2L, 10L))
                .willReturn(false);
        ...
        verify(notificationService).makeNotification(argThat(req ->
                ...
                "COUPON_EXPIRING_SOON:2:10".equals(req.getEventKey()) &&
                req.getArgs() != null &&
    ...
    void syncCouponExpiringNotifications_alreadySent_skipsNotification() {
        ...
        given(notificationCouponQueryService.isCouponExpiringNotificationSentOrInactive(3L, 11L))
                .willReturn(true);
