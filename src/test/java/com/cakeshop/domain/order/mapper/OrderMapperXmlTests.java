...
//Mapper 인터페이스와 XML의 연결 누락을 잡는 안전장치
class OrderMapperXmlTests {

    @Test
    void mapperInterfaceAndXmlStatementsStaySynchronized() throws Exception {
        Configuration configuration = new Configuration();
        String resource = "mapper/order/OrderMapper.xml";
        ...
        Set<String> interfaceMethods = Arrays.stream(OrderMapper.class.getDeclaredMethods())
                .map(Method::getName)
