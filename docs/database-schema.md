...
- 기준 migration: `V0__initial_schema.sql`부터 `V20260819_173713__add_notification_retry_indexes.sql`까지 49개
- 최종 물리 테이블: 49개
