...
- 기준 migration: `V0__initial_schema.sql`부터 `V20260806_162203__add_notification_last_event_at.sql`까지 26개
- 최종 물리 테이블: 41개
...
| 담당 | 도메인 | 테이블 수 | 문서 |
|---|---|---:|---|
| 수민 | 회원 | 3 | [member](schema/member.md) |
...
| 시은 | 통계 | 0 | [statistics](schema/statistics.md) |
