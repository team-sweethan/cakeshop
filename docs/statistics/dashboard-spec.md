...
| 지표 | 후속 구현 사유 |
|---|---|
| 승인 대기 | 주문제작 상태 모델이 확정되어 실제 건수와 이동 기능 구현 |
| 제작 중 | 주문제작 상태 모델이 확정되어 실제 건수와 이동 기능 구현 |
...
- 후속 지표의 카드와 작업 항목은 구현 전까지 대시보드 화면에서 제거하지 않는다.
...
- 구현 전인 후속 지표를 위한 SQL을 실행하거나 다른 도메인의 조회 Service를 호출하지 않는다.
