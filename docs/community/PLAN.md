...
| 클래스 분할 (2026-08-18, 별도 트랙) | `history/2026-08-class-split.md` |
...
| 2026-08-18 | **화면의 작성자 판단을 `PostDetailView.isAuthoredBy`로 이름 붙였다 — 조각 9가 조각 10으로 미뤄 둔 결정을 닫는다.** → 전문은 `history/2026-08-class-split.md` |
| 2026-08-18 | **`CommunityCommentController`·`CommunityReactionController`를 갈라 클래스 분할 10조각을 닫았다.** → 전문은 `history/2026-08-class-split.md` |
| 2026-08-18 | **`CommunityDetailModelAssembler`를 `CommunityDetailPage`로 넓혔다 — 조각 9의 "화면 이름은 여기서 정하지 않는다"를 뒤집는다**(클래스 분할 조각 10의 선행 정리). → 전문은 `history/2026-08-class-split.md` |
| 2026-08-18 | **상세 화면 Model 조립을 `CommunityDetailModelAssembler`로 뗐고, 옮기다 검사 구멍 넷을 찾아 메웠다**(클래스 분할 조각 9). → 전문은 `history/2026-08-class-split.md` |
| 2026-08-18 | **`CommunityService`를 `CommunityPostService`로, `CommunityServiceTests`를 `CommunityPostServiceTests`로 개명했다**(클래스 분할 조각 8의 나머지 절반). → 전문은 `history/2026-08-class-split.md` |
| 2026-08-18 | **좋아요·신고를 `CommunityReactionService`로 뗐다.** → 전문은 `history/2026-08-class-split.md` |
| 2026-08-18 | **댓글을 `CommunityCommentService`로 뗐고, 테스트도 함께 갈랐다.** → 전문은 `history/2026-08-class-split.md` |
| 2026-08-18 | **게시글 접근 규칙을 `CommunityPostAccessPolicy`로 뗐고, 계획했던 범위보다 좁게 잘랐다.** → 전문은 `history/2026-08-class-split.md` |
| 2026-08-18 | **두 벌이던 회원 배치 조회를 `CommunityMemberViewLoader` 하나로 합쳤다.** → 전문은 `history/2026-08-class-split.md` |
| 2026-08-18 | **인기글 문장 여섯을 `CommunityPopularPostMapper`로 뗐다 — 2026-08-05의 "배치 문장을 별도 매퍼로 빼지 않았다"를 뒤집는다.** → 전문은 `history/2026-08-class-split.md` |
| 2026-08-18 | **커뮤니티를 `Post`/`Comment`/`Notice`/`PopularPost` 네 패키지로 가르는 안을 기각하고, 패키지는 그대로 둔 채 클래스만 관심사별로 쪼개기로 했다.** → 전문은 `history/2026-08-class-split.md` |
| 2026-08-18 | **죽은 코드 둘을 지우고 구조 하네스 둘을 고쳤다**(위 결정의 선행 정리). → 전문은 `history/2026-08-class-split.md` |
...
| 2026-08-04 | PR #103 Codex 리뷰 4라운드 4건 반영. → 전문은 `history/2026-08-slice-7-sort-popular.md` |
...
| 2026-08-02 | PR #75 Codex 리뷰 P2 3건 처리. → 전문은 `history/2026-08-slice-1-list-detail.md` |
...
| 2026-08-03 | PR #87 Codex 리뷰 P2 3건 전부 수용. → 전문은 `history/2026-08-slice-2-post-crud.md` |
...
| 2026-08-04 | PR #93 Codex 리뷰 P2 3건 처리. → 전문은 `history/2026-08-slice-3-comment.md` |
| 2026-08-04 | PR #91 Codex 리뷰 P2 2건을 **받아들이지 않기로** 결정하고 R14에 근거를 적었다. → 전문은 `history/2026-08-slice-3-comment.md` |
...
| 2026-08-04 | PR #96 Codex 리뷰 P2 2건 처리. → 전문은 `history/2026-08-slice-5-report-block.md` |
...
| 2026-08-04 | PR #98 Codex 리뷰 3건 전부 처리. → 전문은 `history/2026-08-slice-6-view-dedup.md` |
...
| 2026-08-04 | PR #103 Codex 리뷰 P2 4건 전부 처리. → 전문은 `history/2026-08-slice-7-sort-popular.md` |
| 2026-08-04 | PR #103 Codex 리뷰 **2라운드** P2 4건 전부 처리. → 전문은 `history/2026-08-slice-7-sort-popular.md` |
| 2026-08-04 | PR #103 Codex 리뷰 **3라운드** P2 4건 처리. → 전문은 `history/2026-08-slice-7-sort-popular.md` |
