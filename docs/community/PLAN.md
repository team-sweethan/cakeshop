...
**자리는 메인 최상단으로 정했다**(2026-08-12, 사용자 결정). 착수 전 미정이던 자리다.

**검증**: H45(근거는 spec `검증` 절) — 건수 3, 빈 영역, 그리고 **자리가 다른 섹션보다 앞인지**.
...
| H45 | 메인이 자기 건수로 읽고, 빈 영역은 빠지며, 자리가 최상단임 | `specs/community-notice.md` | **적용** (조각 14c) |
