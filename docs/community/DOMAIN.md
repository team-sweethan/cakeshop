...
| **B8** | 공지 상단 영역 | 누구나 | (B1과 메인 `GET /`에 포함) | **없음** | 14b · 14c | `community-notice.md` |
| **B9** | 공지 전체보기 | 누구나 | `GET /community/notices` | **없음** | 14b | `community-notice.md` |
| **B10** | 공지 상세 | 누구나 | `GET /community/notices/{id}` | **없음** | 14b | `community-notice.md` |
